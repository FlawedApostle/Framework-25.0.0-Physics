...
#include <glew.h>
#include <SDL.h>
#include "Scene7g.h"			/// Scene7g.h  Graphics skybox Reflection PT 2
#include <MMath.h>
#include <QMath.h>
#include "Debug.h"
#include "Texture.h"
...
{
	Debug::Info("Created Scene7g: ", __FILE__, __LINE__);
}
/// DESTRUCTOR
Scene7g::~Scene7g() {
	Debug::Info("Deleted Scene7g: ", __FILE__, __LINE__);
}
/// BUILDING
bool Scene7g::OnCreate() {
	Debug::Info("Loading assets Scene7g: ", __FILE__, __LINE__);
	...
	(
		"textures/Underwater/waterPosX.png",
		"textures/Underwater/waterNegX.png",
		"textures/Underwater/waterPosY.png",
		"textures/Underwater/waterNegY.png",
		"textures/Underwater/waterPosZ.png",
		"textures/Underwater/waterNegZ.png"
	);
...
/// shinyness
	...
	body_cube = new Body();
	body_cube->OnCreate();
	// MESH NOTE:: changed to plane !
	mesh_cube = new Mesh("meshes/Plane.obj");
	mesh_cube->OnCreate();
	body_cube->orientation = QMath::angleAxisRotation(90, Vec3(1, 0, 0));
	/// SHADER
...
/// CLEAN UP !
void Scene7g::OnDestroy() {
	Debug::Info("Deleting assets Scene7g: ", __FILE__, __LINE__);
	/// SPHERE
	body_cube->OnDestroy();
	delete body_cube;
	mesh_cube->OnDestroy();
...
/// JOYSTICK
void Scene7g::HandleEvents(const SDL_Event& sdlEvent) {
	/// To move the mesh
...
/// SHOW TIME
void Scene7g::Update(const float deltaTime)
{
	/*
