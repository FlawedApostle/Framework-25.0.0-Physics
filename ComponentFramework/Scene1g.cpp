...
#include <iostream>
#include <SDL.h>
#include "Scene1g.h"			/// scene1g.h
//#include "Scene0g.h"			/// scene0g.h
#include <MMath.h>
#include "Debug.h"
#include "Mesh.h"
#include "Shader.h"
...
bool Scene1g::OnCreate() {
	...
	//lightPos = Vec3(90.0,0.0,0.0);
	

	shader = new Shader("shaders/phong/phongVert.glsl", "shaders/phong/phongFrag.glsl");
