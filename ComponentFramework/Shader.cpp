...
// -------NEW---------- ERROR SHADER CHECK
void Shader::CheckShader(Shader* shader)
{
	if (shader->OnCreate() == false) {
		std::cerr << "CRITICAL: Shader [" << shader->vertFilename << "] failed to compile/link!\n";
	}
	else
	{
		std::cout << "SUCCESS: Shader loaded.\n";
	}
}
